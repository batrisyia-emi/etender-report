...
void main() {
  group('parsing', () {
    test('reads every field, and null dates stay null', () {
      final record = build(verified: '2026-08-05T14:30:00');
  ...
  group('aging', () {
    ...
    test('a rejected RFC freezes at the verified date', () {
      final record = build(
        status: 'Rejected by 2nd Verifier',
        verified: '2026-08-06T09:15:00',
      );
      expect(record.agingDays(asOf: asOf), 5);
    });

    test('a terminal RFC with no verified date still stops at today', () {
